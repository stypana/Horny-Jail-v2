...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_zzplurt/icons/UI_Icons/title_screen/lego.png' // SPLURT EDIT START: TITLE SCREEN - old value: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
