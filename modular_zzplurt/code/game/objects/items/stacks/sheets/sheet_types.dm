GLOBAL_LIST_INIT(shadow_wood_recipes, list ( \
	...
	new /datum/stack_recipe("shadow wood chair", /obj/structure/chair/wood/shadow, 3, time = 10), \
	new /datum/stack_recipe("shadow wood crate", /obj/structure/closet/crate/wooden/shadow, 6, time = 50),\
	new /datum/stack_recipe("shadow wood bed", /obj/structure/bed/shadow, 2, time = 70),\
	new /datum/stack_recipe("shadow wood double bed", /obj/structure/bed/double/shadow, 4, time = 140),\
	new /datum/stack_recipe("shadow wood barricade", /obj/structure/barricade/wooden/shadow, 5, time = 50), \
	new /datum/stack_recipe("shadow wood dog bed", /obj/structure/bed/dogbed/shadow, 10, time = 10), \
	new /datum/stack_recipe("shadow wood dresser", /obj/structure/dresser/shadow, 10, time = 15), \
	))
