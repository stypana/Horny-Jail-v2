...
/datum/glass_style/drinking_glass/honeystones_love
    required_drink_type = /datum/reagent/consumable/honeystones_love
    name = "Honeystone's Love"
    desc = "A dash of a mother's desire in every silken-drop!~"
    icon = 'modular_zzplurt/icons/obj/drinks/drinks.dmi'
    icon_state = "honeystones_love"
