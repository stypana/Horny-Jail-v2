...
/datum/reagent/blood/expose_turf(turf/exposed_turf, reac_volume)//splash the blood all over the place
	...
	if(data["blood_DNA"])
		...
		if(!bloodsplatter.forensics.blood_DNA["color"])
			bloodsplatter.forensics.blood_DNA["color"] = data["bloodcolor"]
		else
			bloodsplatter.forensics.blood_DNA["color"] = BlendRGB(bloodsplatter.forensics.blood_DNA["color"], data["bloodcolor"])
		bloodsplatter.forensics.blood_DNA["blendmode"] = data["bloodblend"]
