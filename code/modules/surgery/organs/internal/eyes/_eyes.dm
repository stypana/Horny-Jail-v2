...
/obj/item/organ/internal/eyes/proc/generate_body_overlay(mob/living/carbon/human/parent)
	...
	if(my_head.head_flags & HEAD_EYECOLOR)
		if(IS_ROBOTIC_ORGAN(src) || !my_head.draw_color || ((parent.appears_alive() || HAS_TRAIT(parent, TRAIT_UNDEAD)) && !HAS_TRAIT(parent, TRAIT_KNOCKEDOUT)) || HAS_TRAIT(parent, TRAIT_HUSK)) // SPLURT EDIT - ORIGINAL: IS_ROBOTIC_ORGAN(src) || !my_head.draw_color || ((parent.appears_alive() || HAS_TRAIT(parent, TRAIT_UNDEAD)) && !HAS_TRAIT(parent, TRAIT_KNOCKEDOUT))
