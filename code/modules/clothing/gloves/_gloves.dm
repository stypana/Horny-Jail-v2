...
/obj/item/clothing/gloves/worn_overlays(mutable_appearance/standing, isinhands = FALSE)
	...
	if(GET_ATOM_BLOOD_DNA_LENGTH(src))
		. += mutable_appearance(icon = if_colored_blood_then_splurt_icons(), "gloveblood", color = blood_DNA_to_color(), blend_mode = blood_DNA_to_blend()) // SPLURT EDIT - Colored Blood
