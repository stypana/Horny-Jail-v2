...
/obj/item/clothing/gloves/worn_overlays(mutable_appearance/standing, isinhands = FALSE)
	...
	if(GET_ATOM_BLOOD_DNA_LENGTH(src))
		. += mutable_appearance('modular_zzplurt/icons/effects/blood.dmi', "gloveblood", color = blood_DNA_to_color(), blend_mode = blood_DNA_to_blend()) // SPLURT EDIT - Colored Blood
