...
#define JOB_DISPLAY_ORDER_SOUTENEUR 62
#define JOB_DISPLAY_ORDER_ESCORT 63
#define JOB_DISPLAY_ORDER_CLUB_SECURITY 64
...
#define DEPARTMENT_BITFLAG_ENTERTAINMENT (1<<11)
