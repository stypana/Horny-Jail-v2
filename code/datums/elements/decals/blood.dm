...
/datum/element/decal/blood/generate_appearance(_icon, _icon_state, _dir, _plane, _layer, _color, _alpha, _smoothing, source)
	...
	var/mutable_appearance/blood_splatter = mutable_appearance(I.colored_blood_icon('icons/effects/blood.dmi'), "itemblood", appearance_flags = KEEP_APART|RESET_COLOR) //MA of the blood that we apply // SPLURT EDIT - Colored Blood
