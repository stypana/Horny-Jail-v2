                    ...
                    {genital.possible_choices.map((choice) => (
                      <Stack.Item key={choice} grow>
                        <Button
                          ...
                          color={
                            genital.visibility === choice ? 'green' : 'default'
                          }
                          onClick={() =>
                            act('genital', {
                              genital: genital.key,
                  ...
                  <Stack fill>
                    ...
                    <Stack.Item grow>
                      <Button
                        ...
                        icon={
                          genital.always_accessible ? 'hand-paper' : 'hand-rock'
                        }
...
const sortGenitals = (genitals: GenitalData[], searchText = '') => {
  const testSearch = createSearch<GenitalData>(
    searchText,
    (genital) => genital.name,
  );
  return genitals
    .filter((genital) => !searchText || testSearch(genital))
